function [tempDist_final] = findTempDist3D_ellipse(rowIter,sideLength,gridSize,beamPath,tempData)
...
dist = sqrt( (xgrid*dx-beamX).^2 + (ygrid*dx-beamY).^2 + (zgrid*dx-beamZ).^2*3);
