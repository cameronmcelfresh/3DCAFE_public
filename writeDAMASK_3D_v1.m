function [] = writeDAMASK_3D_v1(material,grid,euler,finalGridResolution,workingDirectory)
...
elseif material==2
     copyfile('material_base_file_IN625.txt','material.txt'); %create a fresh file to write over
else
...
gridDownSelected1 = imresize(grid,"nearest",'OutputSize',finalGridResolution);
